...
- `GURU_CARD_YAML`: path to a single .yml file containing the details for all cards. It should contain one entry for each markdown file you wish to add, followed by the ([properties](https://developer.getguru.com/docs/guru-sync-manual-api#cards)) for that individual card, as follows:
```
SomeFile.md: 
  Tags: 
    - "Subject One"
